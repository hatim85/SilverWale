    ...
    <>
      {loading ? (
        ...
        products.map((product, index) => (
          <div key={index} className="border h-[38vh] m-[10px] w-[40vw] md:h-[50vh] sm:w-[15vw] border-gray-500 bg-gray-300 rounded-md shadow-md overflow-hidden relative group">
              ...
              <div className="flex justify-center items-center">
                <img
                  src={(() => {
                    ...
                    return filename ? `/${filename.split(/[\\/]/).pop()}` : '/ErrorImage.png';
                  })()}
